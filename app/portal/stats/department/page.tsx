  ...
  useEffect(() => {
    (async () => {
      if (storeName) {
        ...
        const lastTwoMthDepStats =
          await getLastTwoMonthsDepartmentStats(storeId);
      ...
      <div className='space-y-1'>
        ...
        {storeName ? (
          <p className='text-sm text-muted-foreground'>
            Enter and review monthly department performance for{' '}
          ...
          <p className='text-sm text-muted-foreground'>
            Select a store to enter and review monthly department performance
          </p>
        )}
      </div>

      <div className='max-w-5xl mx-auto px-6 border-b pb-4 mb-6' />
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-6'>
            ...
            <div className='flex justify-between items-center mt-6'>
              ...
              >
                <Plus className='w-5 h-5 text-primary flex-shrink-0' /> Add 5
                More
              </Button>
